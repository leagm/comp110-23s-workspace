...
def greet() -> None:
    ...
    will_you_help(input(f"{WIZARD}: Hello there! I am Grand-dalf the Great! I need your help, mysterious hero! A band of evil trolls have captured some of my mythical creatures and friends. Can you help me rescue them, hero? Y or N: "))
    playing: bool = True
    while playing == True:
        if will_you_help("Y") == True:
            ...
            leave_rescue(input(f"{WIZARD}: That's okay, hero. Would you like to leave this rescue? Stay or Leave?: "))
            if leave_rescue("Leave") == True:
